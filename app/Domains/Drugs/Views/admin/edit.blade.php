    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="name" class="form-control"
                value="{{ old('name', $drug->name) }}" required>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="strength" class="form-control"
                value="{{ old('strength', $drug->strength) }}" placeholder="مثال: 500mg">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="manufacturer" class="form-control"
                value="{{ old('manufacturer', $drug->manufacturer) }}">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="barcode" class="form-control"
                value="{{ old('barcode', $drug->barcode) }}">
            @error('barcode') <span class="text-danger">{{ $message }}</span> @enderror
        </div>

        <div class="col-md-6 mb-3">
            <label class="form-label">الجرعة الافتراضية</label>
            <input type="text" name="default_dosage" class="form-control"
                value="{{ old('default_dosage', $drug->default_dosage) }}" placeholder="مثال: قرص واحد مرتين يومياً">
            @error('default_dosage') <span class="text-danger">{{ $message }}</span> @enderror
        </div>

        <div class="col-md-6 mb-3">
            <label class="form-label">التعليمات الافتراضية</label>
            <input type="text" name="default_instructions" class="form-control"
                value="{{ old('default_instructions', $drug->default_instructions) }}" placeholder="مثال: يؤخذ مع الطعام">
