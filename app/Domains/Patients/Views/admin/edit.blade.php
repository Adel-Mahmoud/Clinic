                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="email" name="user_email" class="form-control" value="{{ old('user_email', optional($patient->user)->email) }}">
                            @error('user_email') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label fw-bold">كلمة المرور (اتركها فارغة إذا لا تريد التغيير)</label>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="general_health_status" class="form-control" rows="3">{{ old('general_health_status', $patient->general_health_status) }}</textarea>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="drug_allergy" class="form-control" rows="3">{{ old('drug_allergy', $patient->drug_allergy) }}</textarea>
